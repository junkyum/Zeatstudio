...
import { TextScrambleProps } from "components/text-scramble/types";
import { randomItem, nextItem } from "components/text-scramble/utils";

const symbols: string[] = "abcdefghijklmnopqrswxz".split("");
